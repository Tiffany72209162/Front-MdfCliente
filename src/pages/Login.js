...
import logo from '../assets/images/logo/logo-jesus-maria.png';
                ...
                <div className="authentication-box">
                  <CardBody className="h-100-d-center">
                    <div className="cont text-center b-light">
                      <div>
                        <Form onSubmit={handleSubmit} className="theme-form" style={{paddingRight:50}}>
                          <h4>Iniciar sesión</h4>
                          <h6>Ingrese su usuario y contraseña</h6>
                          <FormGroup>
                            <Label className="col-form-label pt-0">Tu usuario:</Label>
                            <Input className="form-control" type="text" name="user" onChange={handleChange} defaultValue={credentials.user} required="" />
                          </FormGroup>
                          <FormGroup>
                            <Label className="col-form-label">Contraseña:</Label>
                            <Input className="form-control" type="password" name="pass" onChange={handleChange} defaultValue={credentials.pass} required="" />
                          </FormGroup>
